...
import com.github.malcolmszx.bootstrap.backmsg.InChatBackMapService;
import com.github.malcolmszx.bootstrap.backmsg.InChatBackMapServiceImpl;
...
public class WebSocketHandlerService extends ServerWebSocketHandlerService {
    ...
    public void sendToText(Channel channel, Map<String, Object> maps) {
        ...
        if (websocketChannelService.hasOther(token)){
            //发送给对方--在线
            Channel other = websocketChannelService.getChannel(token);
