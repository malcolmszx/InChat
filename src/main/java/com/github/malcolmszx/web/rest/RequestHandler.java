package com.github.malcolmszx.web.rest;

import com.alibaba.fastjson.JSON;
import com.github.malcolmszx.auto.InitServer;
import com.github.malcolmszx.web.exception.*;
import com.github.malcolmszx.web.rest.convert.Converter;
import com.github.malcolmszx.web.rest.convert.ConverterFactory;
import com.github.malcolmszx.web.rest.mapping.*;
...
final class RequestHandler {
    ...
    public ChannelFuture handleRequest(RequestInfo requestInfo) {
        ...
        if (mapping == null) {
            ...
            // 全局异常处理
            if(InitServer.getExceptionHandler() != null) {
                InitServer.getExceptionHandler().doHandle(new ResourceNotFoundException());
                return null;
            }
        ...
        try {
            ...
            // 全局异常处理
            if(InitServer.getExceptionHandler() != null) {
                InitServer.getExceptionHandler().doHandle(e);
                return null;
            }
